...
<rect x="32.629" y="37.195" width="190.838" height="190.838" style="fill: none; stroke-width: 34px; stroke: rgba(${colors.front} ,${colors.opacity});"/>
<rect x="51.526" y="220.155" width="56.992" height="56.992" style="fill: none; stroke-width: 34px; stroke:rgba(${colors.front} ,${colors.opacity});" transform="matrix(0.707107, 0.707107, -0.707107, 0.707107, 234.467606, 143.222061)"/>
<rect x="82.951" y="354.419" width="91.749" height="91.749" style="stroke-width: 34px; fill: rgba(${colors.front} ,${colors.opacity});" transform="matrix(0, 1, -1, 0, 776.7948, 252.378601)"/>
<rect x="174.683" y="24.329" width="125.233" height="124.821" style="stroke-width: 34px; fill: rgba(${colors.front} ,${colors.opacity});" transform="matrix(0.707107, -0.707107, 0.707107, 0.707107, 141.824875, 246.087555)"/>
</svg>
...
function colorChange(color,inst){
    ...
    if(inst=="back"){
        ...
        document.getElementById("bc").style.backgroundColor=colory
        colors.back = colory
        aplly()
    }
}
